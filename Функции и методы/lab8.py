def count_letters(text):
    """Подсчитывает количество каждой буквы в тексте (без учёта регистра)."""
    letter_counts = {}
...
def calculate_frequency(letter_counts):
    """Вычисляет частоту каждой буквы на основе их количества."""
...
# Подсчитываем буквы и вычисляем их частоту
letter_counts = count_letters(main_str)
frequency = calculate_frequency(letter_counts)

# Сортируем буквы по алфавиту и выводим результат
